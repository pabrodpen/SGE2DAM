...
<head>
    ...
    <style>
        ...
        .imagen-container {
            width: 100%;
            height: 30vh; /* Altura del 30% del alto de la ventana */
            display: flex;
        ...
        .contenido-container {
            ...
            flex-direction: column;
            align-items: center;
            justify-content: space-between; /* Para que haya espacio entre el contenido y la fecha de generación */
        }
